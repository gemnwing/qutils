	...
	public static void main(String[] args) {
		...
		Runnable r = new Runnable() {
			...
			public void run() {
				...
				QLog.setCustomPrefix(Thread.currentThread().getName());
				QLog.println(System.out.hashCode());
				QLog.println("Debug Flag is " + QLog.getDebugFlag());
				QLog.println("Test " + Thread.currentThread().getName());
				...
				QLog.setSaveStackTraceInLog(false);
				QLog.println(System.out.hashCode());
				QLog.println("Debug Flag is " + QLog.getDebugFlag() + " 1");
		...
		new Thread(r, "LOGTESTA").start();
		new Thread(r, "LOGTESTB").start();
	}
}
